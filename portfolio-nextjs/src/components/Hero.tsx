  ...
  return (
    ...
    >
      ...
      <div className="md:pl-[6vw]">
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl italic leading-tight text-charcoal whitespace-nowrap">
          {profile.name}
        </h1>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between w-full min-h-[65vh] mt-8 px-4 gap-8 md:gap-4">
